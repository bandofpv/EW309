...
yaw_control = Controller(yaw_motor, P=1, I=1, D=1, sampling_rate)
pitch_control = Controller(pitch_motor, P=1, I=1, D=1, sampling_rate)

move = False  # moving flag
...
while True:
    ...
    if data:
        ...
        if yaw_control.move_to_angle(yaw, 10):
            move = False
